...
package com.android.dialer2.dialpad;

import android.text.TextUtils;

import com.android.dialer2.dialpad.SmartDialPrefix.PhoneNumberTokens;
...
public class SmartDialNameMatcher {
    ...
    private final ArrayList<com.android.dialer2.dialpad.SmartDialMatchPosition> mMatchPositions = Lists.newArrayList();

    public static final com.android.dialer2.dialpad.SmartDialMap LATIN_SMART_DIAL_MAP = new com.android.dialer2.dialpad.LatinSmartDialMap();

    private final com.android.dialer2.dialpad.SmartDialMap mMap;
    ...
    public SmartDialNameMatcher(String query, com.android.dialer2.dialpad.SmartDialMap map) {
        mQuery = query;
        mMap = map;
    }
     ...
     */
    private void replaceBitInMask(StringBuilder builder, com.android.dialer2.dialpad.SmartDialMatchPosition matchPos) {
     ...
     */
    public static String normalizeNumber(String number, com.android.dialer2.dialpad.SmartDialMap map) {
     ...
     * @return Phone number consisting of digits from 0-9
     */
    public static String normalizeNumber(String number, int offset, com.android.dialer2.dialpad.SmartDialMap map) {
     ...
     */
    @VisibleForTesting
    public com.android.dialer2.dialpad.SmartDialMatchPosition matchesNumber(String phoneNumber, String query, boolean useNanp) {
        StringBuilder builder = new StringBuilder();
        constructEmptyMask(builder, phoneNumber.length());
        mPhoneNumberMatchMask = builder.toString();

        // Try matching the number as is
        com.android.dialer2.dialpad.SmartDialMatchPosition matchPos = matchesNumberWithOffset(phoneNumber, query, 0);
        if (matchPos == null) {
            final PhoneNumberTokens phoneNumberTokens =
                    com.android.dialer2.dialpad.SmartDialPrefix.parsePhoneNumber(phoneNumber);
     ...
     *         SmartDialMatchPosition with the matching positions otherwise
     */
    public com.android.dialer2.dialpad.SmartDialMatchPosition matchesNumber(String phoneNumber) {
     ...
     *         SmartDialMatchPosition with the matching positions otherwise
     */
    public com.android.dialer2.dialpad.SmartDialMatchPosition matchesNumber(String phoneNumber, String query) {
     ...
     *         SmartDialMatchPosition with the matching positions otherwise
     */
    private com.android.dialer2.dialpad.SmartDialMatchPosition matchesNumberWithOffset(String phoneNumber, String query,
                                                                                      int offset) {
        ...
        return new com.android.dialer2.dialpad.SmartDialMatchPosition(0 + offset, numberAt);
    }
    ...
    boolean matchesCombination(String displayName, String query,
            ArrayList<com.android.dialer2.dialpad.SmartDialMatchPosition> matchList) {
        StringBuilder builder = new StringBuilder();
        ...
        ArrayList<com.android.dialer2.dialpad.SmartDialMatchPosition> partial = new ArrayList<com.android.dialer2.dialpad.SmartDialMatchPosition>();
            ...
            if (mMap.isValidDialpadCharacter(ch)) {
                ...
                if (ch != query.charAt(queryStart)) {
                    ...
                    if (queryStart == queryLength - 1) {
                        ...
                        matchList.add(new com.android.dialer2.dialpad.SmartDialMatchPosition(
                                tokenStart, queryLength + tokenStart + seperatorCount));
                        for (com.android.dialer2.dialpad.SmartDialMatchPosition match : matchList) {
                        ...
                        if (j < nameLength - 1) {
                            ...
                            final ArrayList<com.android.dialer2.dialpad.SmartDialMatchPosition> partialTemp =
                                    Lists.newArrayList();
                            if (matchesCombination(
                                    remainder, query.substring(queryStart + 1), partialTemp)) {

                                // store the list of possible match positions
                                com.android.dialer2.dialpad.SmartDialMatchPosition.advanceMatchPositions(partialTemp, j + 1);
                                partialTemp.add(0,
                                        new com.android.dialer2.dialpad.SmartDialMatchPosition(nameStart, nameStart + 1));
    ...
    public ArrayList<com.android.dialer2.dialpad.SmartDialMatchPosition> getMatchPositions() {
        // Return a clone of mMatchPositions so that the caller can use it without
        // worrying about it changing
        return new ArrayList<com.android.dialer2.dialpad.SmartDialMatchPosition>(mMatchPositions);
    }
