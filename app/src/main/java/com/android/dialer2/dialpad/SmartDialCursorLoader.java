...
import com.android.dialer2.database.DialerDatabaseHelper.ContactNumber;
...
public class SmartDialCursorLoader extends AsyncTaskLoader<Cursor> {
    ...
    private com.android.dialer2.dialpad.SmartDialNameMatcher mNameMatcher;
    ...
    public void configureQuery(String query) {
        ...
        mQuery = com.android.dialer2.dialpad.SmartDialNameMatcher.normalizeNumber(query, com.android.dialer2.dialpad.SmartDialPrefix.getMap());

        /** Constructs a name matcher object for matching names. */
        mNameMatcher = new com.android.dialer2.dialpad.SmartDialNameMatcher(mQuery, com.android.dialer2.dialpad.SmartDialPrefix.getMap());
    }
