...
package com.android.dialer2.contactinfo;

import android.os.Handler;
import android.os.Message;
import android.text.TextUtils;

import com.android.dialer2.calllog.ContactInfo;
import com.android.dialer2.calllog.ContactInfoHelper;
import com.android.dialer2.util.ExpirableCache;
...
public class ContactInfoCache {
    ...
    private class QueryThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                ...
                com.android.dialer2.contactinfo.ContactInfoRequest req = null;
     ...
     */
    private final LinkedList<com.android.dialer2.contactinfo.ContactInfoRequest> mRequests;

    private ExpirableCache<com.android.dialer2.contactinfo.NumberWithCountryIso, ContactInfo> mCache;
    ...
    public ContactInfoCache(ContactInfoHelper contactInfoHelper,
        ...
        mRequests = new LinkedList<com.android.dialer2.contactinfo.ContactInfoRequest>();
    ...
    public ContactInfo getValue(String number, String countryIso, ContactInfo cachedContactInfo) {
        com.android.dialer2.contactinfo.NumberWithCountryIso numberCountryIso = new com.android.dialer2.contactinfo.NumberWithCountryIso(number, countryIso);
    ...
    protected void enqueueRequest(String number, String countryIso, ContactInfo callLogInfo,
            boolean immediate) {
        com.android.dialer2.contactinfo.ContactInfoRequest request = new com.android.dialer2.contactinfo.ContactInfoRequest(number, countryIso, callLogInfo);
        synchronized (mRequests) {
