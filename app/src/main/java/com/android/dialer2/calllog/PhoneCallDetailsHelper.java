...
public class PhoneCallDetailsHelper {
    ...
    private final com.android.dialer2.calllog.TelecomCallLogCache mTelecomCallLogCache;
    ...
    public PhoneCallDetailsHelper(
            Context context,
            Resources resources,
            com.android.dialer2.calllog.TelecomCallLogCache telecomCallLogCache) {
        mContext = context;
    ...
    public void setPhoneCallDetails(com.android.dialer2.calllog.PhoneCallDetailsViews views, PhoneCallDetails details) {
        ...
        if (accountLabel != null) {
            ...
            int color = com.android.dialer2.calllog.PhoneAccountUtils.getAccountColor(mContext, details.accountHandle);
    ...
    private void setCallCountAndDate(com.android.dialer2.calllog.PhoneCallDetailsViews views, Integer callCount,
