...
public class CallLogActivity extends Activity implements ViewPager.OnPageChangeListener {
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case TAB_INDEX_ALL:
                    return new CallLogFragment(com.android.dialer2.calllog.CallLogQueryHandler.CALL_TYPE_ALL);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.delete_all:
                com.android.dialer2.calllog.ClearCallLogDialog.show(getFragmentManager());
                return true;
        }
