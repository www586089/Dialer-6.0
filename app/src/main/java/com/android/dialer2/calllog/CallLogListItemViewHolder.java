...
import com.android.dialer2.calllog.CallLogAsyncTaskUtil;
import com.android.dialer2.util.DialerUtils;
import com.android.dialer2.util.PhoneNumberUtil;
import com.android.dialer2.voicemail.VoicemailPlaybackLayout;
...
public final class CallLogListItemViewHolder extends RecyclerView.ViewHolder
            ...
            if (canPlaceCallToNumber) {
                ...
                if (isVoicemailNumber) {
                    ...
                    primaryActionButtonView.setTag(
                            com.android.dialer2.calllog.IntentProvider.getReturnVoicemailCallIntentProvider());
                } else {
                    primaryActionButtonView.setTag(
                            com.android.dialer2.calllog.IntentProvider.getReturnCallIntentProvider(number));
                }
    ...
    private void bindActionButtons() {
        ...
        if (!TextUtils.isEmpty(voicemailUri) && canPlaceCallToNumber) {
            callButtonView.setTag(com.android.dialer2.calllog.IntentProvider.getReturnCallIntentProvider(number));
        ...
        if (mTelecomCallLogCache.isVideoEnabled() && canPlaceCallToNumber &&
            ...
            videoCallButtonView.setTag(com.android.dialer2.calllog.IntentProvider.getReturnVideoCallIntentProvider(number));
        ...
        detailsButtonView.setTag(
                com.android.dialer2.calllog.IntentProvider.getCallDetailIntentProvider(rowId, callIds, null));

        if (info != null && UriUtils.isEncodedContactUri(info.lookupUri)) {
            createNewContactButtonView.setTag(com.android.dialer2.calllog.IntentProvider.getAddContactIntentProvider(
                    info.lookupUri, info.name, info.number, info.type, true /* isNewContact */));
            createNewContactButtonView.setVisibility(View.VISIBLE);

            addToExistingContactButtonView.setTag(com.android.dialer2.calllog.IntentProvider.getAddContactIntentProvider(
        ...
        sendMessageView.setTag(com.android.dialer2.calllog.IntentProvider.getSendSmsIntentProvider(number));
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.primary_action_button && !TextUtils.isEmpty(voicemailUri)) {
            ...
            final com.android.dialer2.calllog.IntentProvider intentProvider = (com.android.dialer2.calllog.IntentProvider) view.getTag();
