...
public final class PhoneCallDetailsViews {
    ...
    public final com.android.dialer2.calllog.CallTypeIconsView callTypeIcons;
    public final TextView callLocationAndDate;
    public final TextView voicemailTranscriptionView;
    public final TextView callAccountLabel;

    private PhoneCallDetailsViews(TextView nameView, View callTypeView,
                                  com.android.dialer2.calllog.CallTypeIconsView callTypeIcons, TextView callLocationAndDate,
    ...
    public static PhoneCallDetailsViews fromView(View view) {
        return new PhoneCallDetailsViews((TextView) view.findViewById(R.id.name),
                ...
                (com.android.dialer2.calllog.CallTypeIconsView) view.findViewById(R.id.call_type_icons),
    ...
    public static PhoneCallDetailsViews createForTest(Context context) {
        return new PhoneCallDetailsViews(
                ...
                new View(context),
                new com.android.dialer2.calllog.CallTypeIconsView(context),
                new TextView(context),
                new TextView(context),
                new TextView(context));
    }
