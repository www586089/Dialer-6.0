...
import com.android.dialer2.util.AsyncTaskExecutor;
import com.android.dialer2.util.AsyncTaskExecutors;
    ...
    public static void markVoicemailAsRead(final Context context, final Uri voicemailUri) {
        ...
        sAsyncTaskExecutor.submit(Tasks.MARK_VOICEMAIL_READ, new AsyncTask<Void, Void, Void>() {
            ...
            public Void doInBackground(Void... params) {
                ...
                Intent intent = new Intent(context, com.android.dialer2.calllog.CallLogNotificationsService.class);
                intent.setAction(com.android.dialer2.calllog.CallLogNotificationsService.ACTION_MARK_NEW_VOICEMAILS_AS_OLD);
