...
public class CallLogGroupBuilder {
    ...
    public void addGroups(Cursor cursor) {
        ...
        String firstNumber = cursor.getString(com.android.dialer2.calllog.CallLogQuery.NUMBER);
        // This is the type of the first call in the group.
        int firstCallType = cursor.getInt(com.android.dialer2.calllog.CallLogQuery.CALL_TYPE);

        // The account information of the first entry in the group.
        String firstAccountComponentName = cursor.getString(com.android.dialer2.calllog.CallLogQuery.ACCOUNT_COMPONENT_NAME);
        String firstAccountId = cursor.getString(com.android.dialer2.calllog.CallLogQuery.ACCOUNT_ID);

        // Determine the day group for the first call in the cursor.
        final long firstDate = cursor.getLong(com.android.dialer2.calllog.CallLogQuery.DATE);
        final long firstRowId = cursor.getLong(com.android.dialer2.calllog.CallLogQuery.ID);
        ...
        while (cursor.moveToNext()) {
            ...
            final String currentNumber = cursor.getString(com.android.dialer2.calllog.CallLogQuery.NUMBER);
            final int callType = cursor.getInt(com.android.dialer2.calllog.CallLogQuery.CALL_TYPE);
            final String currentAccountComponentName = cursor.getString(
                    com.android.dialer2.calllog.CallLogQuery.ACCOUNT_COMPONENT_NAME);
            final String currentAccountId = cursor.getString(com.android.dialer2.calllog.CallLogQuery.ACCOUNT_ID);
            ...
            final long currentCallId = cursor.getLong(com.android.dialer2.calllog.CallLogQuery.ID);
            final long date = cursor.getLong(com.android.dialer2.calllog.CallLogQuery.DATE);
