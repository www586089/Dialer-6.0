...
public class CallLogNotificationsService extends IntentService {
    ...
    private com.android.dialer2.calllog.VoicemailQueryHandler mVoicemailQueryHandler;
    ...
    public void onCreate() {
        super.onCreate();
        mVoicemailQueryHandler = new com.android.dialer2.calllog.VoicemailQueryHandler(this, getContentResolver());
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (ACTION_MARK_NEW_VOICEMAILS_AS_OLD.equals(intent.getAction())) {
            ...
            com.android.dialer2.calllog.DefaultVoicemailNotifier.getInstance(this).updateNotification(voicemailUri);
        } else {
