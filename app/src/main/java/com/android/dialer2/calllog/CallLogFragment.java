...
import com.android.dialer2.util.EmptyLoader;
 ...
 */
public class CallLogFragment extends Fragment implements com.android.dialer2.calllog.CallLogQueryHandler.Listener,
        com.android.dialer2.calllog.CallLogAdapter.CallFetcher, OnEmptyViewActionButtonClickedListener {
    ...
    private com.android.dialer2.calllog.CallLogAdapter mAdapter;
    private com.android.dialer2.calllog.CallLogQueryHandler mCallLogQueryHandler;
    ...
    private int mCallTypeFilter = com.android.dialer2.calllog.CallLogQueryHandler.CALL_TYPE_ALL;
    ...
    public CallLogFragment() {
        this(com.android.dialer2.calllog.CallLogQueryHandler.CALL_TYPE_ALL, NO_LOG_LIMIT);
    }
    ...
    public void onCreate(Bundle state) {
        ...
        mCallLogQueryHandler = new com.android.dialer2.calllog.CallLogQueryHandler(activity, resolver, this, mLogLimit);
        mKeyguardManager =
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedState) {
        ...
        mAdapter = ObjectFactory.newCallLogAdapter(
                getActivity(),
                this,
                new com.android.dialer2.calllog.ContactInfoHelper(getActivity(), currentCountryIso),
    ...
    private void updateEmptyMessage(int filterType) {
        ...
        switch (filterType) {
            ...
            case Calls.VOICEMAIL_TYPE:
                ...
                break;
            case com.android.dialer2.calllog.CallLogQueryHandler.CALL_TYPE_ALL:
    ...
    com.android.dialer2.calllog.CallLogAdapter getAdapter() {
        return mAdapter;
    }
    ...
    private void updateOnTransition(boolean onEntry) {
        ...
        if (mKeyguardManager != null && !mKeyguardManager.inKeyguardRestrictedInputMode()) {
            ...
            com.android.dialer2.calllog.CallLogNotificationsHelper.removeMissedCallNotifications(getActivity());
            com.android.dialer2.calllog.CallLogNotificationsHelper.updateVoicemailNotifications(getActivity());
        }
    }
