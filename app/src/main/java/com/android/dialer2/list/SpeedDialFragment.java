...
public class SpeedDialFragment extends Fragment implements OnItemClickListener,
        com.android.dialer2.list.PhoneFavoritesTileAdapter.OnDataSetChangedForAnimationListener,
    ...
    public interface HostInterface {
        public void setDragDropController(com.android.dialer2.list.DragDropController controller);
    ...
    private com.android.dialer2.list.OnListFragmentScrolledListener mActivityScrollListener;
    private com.android.dialer2.list.PhoneFavoritesTileAdapter mContactTileAdapter;

    private View mParentView;

    private com.android.dialer2.list.PhoneFavoriteListView mListView;
    ...
    public void onAttach(Activity activity) {
        ...
        mContactTileAdapter = new com.android.dialer2.list.PhoneFavoritesTileAdapter(activity, mContactTileAdapterListener,
                this);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mListView = (com.android.dialer2.list.PhoneFavoriteListView) mParentView.findViewById(R.id.contact_tile_list);
    ...
    public void onStart() {
        ...
        try {
            mActivityScrollListener = (com.android.dialer2.list.OnListFragmentScrolledListener) activity;
        ...
        try {
            com.android.dialer2.list.OnDragDropListener listener = (com.android.dialer2.list.OnDragDropListener) activity;
