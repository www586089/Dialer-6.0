...
import com.android.dialer2.dialpad.SmartDialCursorLoader;
...
public class SmartDialSearchFragment extends SearchFragment
    ...
    protected ContactEntryListAdapter createListAdapter() {
        com.android.dialer2.list.SmartDialNumberListAdapter adapter = new com.android.dialer2.list.SmartDialNumberListAdapter(getActivity());
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        if (id == getDirectoryLoaderId()) {
            ...
            final com.android.dialer2.list.SmartDialNumberListAdapter adapter = (com.android.dialer2.list.SmartDialNumberListAdapter) getAdapter();
