package com.android.dialer2.list;
...
import com.android.dialer2.calllog.CallLogQueryHandler;
import com.android.dialer2.util.DialerUtils;
import com.android.dialer2.voicemail.VoicemailStatusHelper;
import com.android.dialer2.voicemail.VoicemailStatusHelperImpl;
...
public class ListsFragment extends Fragment
    ...
    private com.android.dialer2.list.RemoveView mRemoveView;
    private View mRemoveViewContent;

    private com.android.dialer2.list.SpeedDialFragment mSpeedDialFragment;
    private CallLogFragment mRecentsFragment;
    private com.android.dialer2.list.AllContactsFragment mAllContactsFragment;
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (getRtlPosition(position)) {
                case TAB_INDEX_SPEED_DIAL:
                    mSpeedDialFragment = new com.android.dialer2.list.SpeedDialFragment();
                ...
                case TAB_INDEX_ALL_CONTACTS:
                    mAllContactsFragment = new com.android.dialer2.list.AllContactsFragment();
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (fragment instanceof com.android.dialer2.list.SpeedDialFragment) {
                mSpeedDialFragment = (com.android.dialer2.list.SpeedDialFragment) fragment;
            } else if (fragment instanceof CallLogFragment && position == TAB_INDEX_RECENTS) {
                mRecentsFragment = (CallLogFragment) fragment;
            } else if (fragment instanceof com.android.dialer2.list.AllContactsFragment) {
                mAllContactsFragment = (com.android.dialer2.list.AllContactsFragment) fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRemoveView = (com.android.dialer2.list.RemoveView) parentView.findViewById(R.id.remove_view);
    ...
    public com.android.dialer2.list.SpeedDialFragment getSpeedDialFragment() {
        return mSpeedDialFragment;
    }

    public com.android.dialer2.list.RemoveView getRemoveView() {
        return mRemoveView;
    }
    ...
    public void sendScreenViewForCurrentPosition() {
        ...
        switch (getCurrentTabIndex()) {
            case TAB_INDEX_SPEED_DIAL:
                fragmentName = com.android.dialer2.list.SpeedDialFragment.class.getSimpleName();
                break;
            case TAB_INDEX_RECENTS:
                fragmentName = CallLogFragment.class.getSimpleName() + "#Recents";
                break;
            case TAB_INDEX_ALL_CONTACTS:
                fragmentName = com.android.dialer2.list.AllContactsFragment.class.getSimpleName();
                break;
            case TAB_INDEX_VOICEMAIL:
