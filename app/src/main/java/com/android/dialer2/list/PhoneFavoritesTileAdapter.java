...
public class PhoneFavoritesTileAdapter extends BaseAdapter implements
        com.android.dialer2.list.OnDragDropListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.android.dialer2.list.PhoneFavoriteTileView tileView = null;

        if (convertView instanceof com.android.dialer2.list.PhoneFavoriteTileView) {
            tileView  = (com.android.dialer2.list.PhoneFavoriteTileView) convertView;
        }

        if (tileView == null) {
            tileView = (com.android.dialer2.list.PhoneFavoriteTileView) View.inflate(mContext, R.layout.phone_favorite_tile_view, null);
        }
    ...
    @Override
    public void onDragStarted(int x, int y, com.android.dialer2.list.PhoneFavoriteSquareTileView view) {
        setInDragging(true);
    ...
    @Override
    public void onDragHovered(int x, int y, com.android.dialer2.list.PhoneFavoriteSquareTileView view) {
        if (view == null) {
