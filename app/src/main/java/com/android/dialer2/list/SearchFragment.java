...
import com.android.dialer2.dialpad.DialpadFragment.ErrorDialogFragment;
...
public class SearchFragment extends PhoneNumberPickerFragment {
    ...
    protected ContactEntryListAdapter createListAdapter() {
        com.android.dialer2.list.DialerPhoneNumberListAdapter adapter = new com.android.dialer2.list.DialerPhoneNumberListAdapter(getActivity());
    ...
    protected void onItemClick(int position, long id) {
        final com.android.dialer2.list.DialerPhoneNumberListAdapter adapter = (com.android.dialer2.list.DialerPhoneNumberListAdapter) getAdapter();
        ...
        switch (shortcutType) {
            case com.android.dialer2.list.DialerPhoneNumberListAdapter.SHORTCUT_INVALID:
                super.onItemClick(position, id);
                break;
            case com.android.dialer2.list.DialerPhoneNumberListAdapter.SHORTCUT_DIRECT_CALL:
                ...
                break;
            case com.android.dialer2.list.DialerPhoneNumberListAdapter.SHORTCUT_CREATE_NEW_CONTACT:
                ...
                break;
            case com.android.dialer2.list.DialerPhoneNumberListAdapter.SHORTCUT_ADD_TO_EXISTING_CONTACT:
                number = TextUtils.isEmpty(mAddToContactNumber) ?
                        adapter.getFormattedQueryString() : mAddToContactNumber;
                ...
                break;
            case com.android.dialer2.list.DialerPhoneNumberListAdapter.SHORTCUT_SEND_SMS_MESSAGE:
                number = adapter.getFormattedQueryString();
                intent = IntentUtil.getSendSmsIntent(number);
                DialerUtils.startActivityWithErrorToast(getActivity(), intent);
                break;
            case com.android.dialer2.list.DialerPhoneNumberListAdapter.SHORTCUT_MAKE_VIDEO_CALL:
                number = adapter.getQueryString();
                listener = getOnPhoneNumberPickerListener();
                if (listener != null && !checkForProhibitedPhoneNumber(number)) {
    ...
    protected void startLoading() {
        if (PermissionsUtil.hasPermission(getActivity(), READ_CONTACTS)) {
            ...
            final com.android.dialer2.list.DialerPhoneNumberListAdapter adapter =
                    (com.android.dialer2.list.DialerPhoneNumberListAdapter) getAdapter();
