...
public class RegularSearchFragment extends SearchFragment
    ...
    protected ContactEntryListAdapter createListAdapter() {
        com.android.dialer2.list.RegularSearchListAdapter adapter = new com.android.dialer2.list.RegularSearchListAdapter(getActivity());
    ...
    protected void cacheContactInfo(int position) {
        if (mCachedNumberLookupService != null) {
            final com.android.dialer2.list.RegularSearchListAdapter adapter =
                (com.android.dialer2.list.RegularSearchListAdapter) getAdapter();
