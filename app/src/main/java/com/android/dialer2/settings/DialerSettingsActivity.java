package com.android.dialer2.settings;
...
public class DialerSettingsActivity extends PreferenceActivity {
    ...
    public void onBuildHeaders(List<Header> target) {
        ...
        displayOptionsHeader.fragment = com.android.dialer2.settings.DisplayOptionsSettingsFragment.class.getName();
        target.add(displayOptionsHeader);

        Header soundSettingsHeader = new Header();
        soundSettingsHeader.titleRes = R.string.sounds_and_vibration_title;
        soundSettingsHeader.fragment = com.android.dialer2.settings.SoundSettingsFragment.class.getName();
