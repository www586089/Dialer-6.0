...
package com.android.dialer2.util;
...
public final class AsyncTaskExecutors {
     ...
     */
    public static com.android.dialer2.util.AsyncTaskExecutor createAsyncTaskExecutor() {
     ...
     */
    public static com.android.dialer2.util.AsyncTaskExecutor createThreadPoolExecutor() {
        synchronized (AsyncTaskExecutors.class) {
            if (mInjectedAsyncTaskExecutorFactory != null) {
                return mInjectedAsyncTaskExecutorFactory.createAsyncTaskExeuctor();
            }
    ...
    public interface AsyncTaskExecutorFactory {
        com.android.dialer2.util.AsyncTaskExecutor createAsyncTaskExeuctor();
    }
    ...
    private static class SimpleAsyncTaskExecutor implements com.android.dialer2.util.AsyncTaskExecutor {
