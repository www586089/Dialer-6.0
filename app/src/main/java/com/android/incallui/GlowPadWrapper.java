...
public class GlowPadWrapper extends GlowPadView implements GlowPadView.OnTriggerListener {
    ...
    public void onTrigger(View v, int target) {
        ...
        if (R.drawable.ic_lockscreen_answer == resId) {
            mAnswerListener.onAnswer(VideoProfile.STATE_AUDIO_ONLY, getContext());
            mTargetTriggered = true;
        } else if (R.drawable.ic_lockscreen_decline == resId) {
            mAnswerListener.onDecline(getContext());
            mTargetTriggered = true;
        } else if (R.drawable.ic_lockscreen_text == resId) {
            mAnswerListener.onText();
            mTargetTriggered = true;
        } else if (R.drawable.ic_videocam == resId || R.drawable.ic_lockscreen_answer_video == resId) {
            mAnswerListener.onAnswer(mVideoState, getContext());
            mTargetTriggered = true;
        } else if (R.drawable.ic_lockscreen_decline_video == resId) {
