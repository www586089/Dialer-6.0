...
public class CallButtonFragment
    ...
    public void onClick(View view) {
        ...
        if (R.id.audioButton == id) {
            onAudioButtonClicked();
        } else if (R.id.addButton == id) {
            getPresenter().addCallClicked();
        } else if (R.id.muteButton == id) {
            getPresenter().muteClicked(!mMuteButton.isSelected());
        } else if (R.id.mergeButton == id) {
            getPresenter().mergeClicked();
            mMergeButton.setEnabled(false);
        } else if (R.id.holdButton == id) {
            getPresenter().holdClicked(!mHoldButton.isSelected());
        } else if (R.id.swapButton == id) {
            getPresenter().swapClicked();
        } else if (R.id.dialpadButton == id) {
            getPresenter().showDialpadClicked(!mShowDialpadButton.isSelected());
        } else if (R.id.changeToVideoButton == id) {
            getPresenter().changeToVideoClicked();
        } else if (R.id.switchCameraButton == id) {
            getPresenter().switchCameraClicked(mSwitchCameraButton.isSelected() /* useFrontFacingCamera */);
        } else if (R.id.pauseVideoButton == id) {
            getPresenter().pauseVideoClicked(!mPauseVideoButton.isSelected() /* pause */);
        } else if (R.id.overflowButton == id) {
            if (mOverflowPopup != null) {
                mOverflowPopup.show();
            }
        } else if (R.id.manageVideoCallConferenceButton == id) {
