...
public class DialpadView extends LinearLayout {
    ...
    private int getKeyButtonAnimationDelay(int buttonId) {
        if (mIsLandscape) {
            if (mIsRtl) {
                ...
                } else if (R.id.six == buttonId) {
                    return KEY_FRAME_DURATION * 2;
                } else if (R.id.nine == buttonId) {
                    return KEY_FRAME_DURATION * 3;
                } else if (R.id.pound == buttonId) {
                    return KEY_FRAME_DURATION * 4;
                } else if (R.id.two == buttonId) {
                    return KEY_FRAME_DURATION * 5;
                } else if (R.id.five == buttonId) {
                    return KEY_FRAME_DURATION * 6;
                } else if (R.id.eight == buttonId) {
                    return KEY_FRAME_DURATION * 7;
                } else if (R.id.zero == buttonId) {
                    return KEY_FRAME_DURATION * 8;
                } else if (R.id.one == buttonId) {
                    return KEY_FRAME_DURATION * 9;
                } else if (R.id.four == buttonId) {
                    return KEY_FRAME_DURATION * 10;
                } else if (R.id.seven == buttonId || R.id.star == buttonId) {
                ...
                if (R.id.one == buttonId) {
                    ...
                    return KEY_FRAME_DURATION * 2;
                } else if (R.id.seven == buttonId) {
                    return KEY_FRAME_DURATION * 3;
                } else if (R.id.star == buttonId) {
                    return KEY_FRAME_DURATION * 4;
                } else if (R.id.two == buttonId) {
                    return KEY_FRAME_DURATION * 5;
                } else if (R.id.five == buttonId) {
                    ...
                    return KEY_FRAME_DURATION * 8;
                } else if (R.id.three == buttonId) {
                    return KEY_FRAME_DURATION * 9;
                } else if (R.id.six == buttonId) {
                    return KEY_FRAME_DURATION * 10;
                } else if (R.id.nine == buttonId || R.id.pound == buttonId) {
                    return KEY_FRAME_DURATION * 11;
                }
            }
        } else {
            if (R.id.one == buttonId) {
                ...
                return KEY_FRAME_DURATION * 10;
            } else if (R.id.zero == buttonId || R.id.pound == buttonId) {
                return KEY_FRAME_DURATION * 11;
            }
        }
    ...
    private int getKeyButtonAnimationDuration(int buttonId) {
        if (mIsLandscape) {
            if (mIsRtl) {
                if (R.id.one == buttonId || R.id.four == buttonId || R.id.seven == buttonId || R.id.star == buttonId) {
                    return KEY_FRAME_DURATION * 8;
                } else if (R.id.two == buttonId || R.id.five == buttonId || R.id.eight == buttonId || R.id.zero == buttonId) {
                    return KEY_FRAME_DURATION * 9;
                } else if (R.id.three == buttonId || R.id.six == buttonId || R.id.nine == buttonId || R.id.pound == buttonId) {
                    return KEY_FRAME_DURATION * 10;
                }
            } else {
                if (R.id.one == buttonId || R.id.four == buttonId || R.id.seven == buttonId || R.id.star == buttonId) {
            ...
            if (R.id.one == buttonId || R.id.two == buttonId || R.id.three == buttonId || R.id.four == buttonId || R.id.five == buttonId || R.id.six == buttonId) {
                return KEY_FRAME_DURATION * 10;
            } else if (R.id.seven == buttonId || R.id.eight == buttonId || R.id.nine == buttonId) {
                return KEY_FRAME_DURATION * 9;
            } else if (R.id.star == buttonId || R.id.zero == buttonId || R.id.pound == buttonId) {
                return KEY_FRAME_DURATION * 8;
            }
        }
